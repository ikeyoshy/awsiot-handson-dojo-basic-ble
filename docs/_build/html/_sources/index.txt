...
* AWSアカウント
	...
	* 一つのアカウントでの実施も可能です。その場合。事前に**IAMユーザー**を作って頂くことになります。
    **IAMユーザー**の作成方法は、事前準備の項を参照して下さい。
* PC、もしくは Mac
	* Windows PCもしくは、Macを使用します。参加者お一人に1台のマシンをご用意して頂きます。
  * 各種設定を行うためにWebブラウザを使用します。インターネットエクスプローラーとFireFoxでは、問題が出る場合が有り、Webブラウザは、必ず、Google Chromeをお使い下さい。
* ACコンセント

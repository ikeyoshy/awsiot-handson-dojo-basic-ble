...
3. AWSアカウント
   ...
   * 複数の参加者で1つのAWSアカウントを共用してハンズオンを実施することも可能です。その場合。事前にIAMユーザーを作って頂くことになります。IAMユーザーの作成方法は、`事前準備 <http://awsiot-handson-dojo-basic-ble.readthedocs.io/en/latest/index.html#aws>`_  のセクションを参照して下さい。
